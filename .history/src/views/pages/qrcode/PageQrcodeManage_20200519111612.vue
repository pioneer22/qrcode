    ...
    <el-card class="card" v-if="show===3" shadow="hover">
      ...
      <el-form :model="childData" :rules="rules" ref="childData" label-width="100px">
        ...
        <div style="padding-left: 20px;">
          <el-upload ref="upload" class="upload-demo" :action="url" :show-file-list="false" :on-success="handleSuccess"
            :on-change="handleChange" :limit="1" :auto-upload="false" list-type="picture-card">
