  ...
  <div>
    <el-card class="card" v-if="show===1" shadow="hover">
      ...
      <el-table :data="tableData" :default-sort="{prop: 'id',order: 'ascending'}" style="width: 100%"
        v-if="tableData.length > 0" v-cloak>
    ...
    <el-card class="card" v-if="show===2" shadow="hover">
      ...
      <el-table :data="childDatas" style="width: 100%" v-if="childDatas.length > 0" v-cloak>
        <el-table-column label="ID" sortable prop="id" width="150">
          <template slot-scope="scope">
            <span>{{ scope.row.id }}</span>
          </template>
    ...
    watch: {
      ...
      'childData.subcode_sort': {
        handler() {
          ...
          this.childData.subcode_sort = isNaN(parseInt(this.childData.subcode_sort)) ? 0 : (parseInt(this.childData.subcode_sort) > 100 ? 100 : parseInt(this.childData.subcode_sort))
        }
      },
      'childData.toplimit': {
        handler() {
