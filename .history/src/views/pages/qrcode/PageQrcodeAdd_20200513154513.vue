          ...
          <el-card shadow="hover" style="width: 100%;">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
              ...
              <div class="upload-content">
                <el-upload class="upload-demo" ref="upload" :show-file-list="false" :auto-upload="false" drag
                  action="https://jsonplaceholder.typicode.com/posts/" list-type="picture" :on-success="handleSuccess"
                  :on-change="handleChange" :before-upload="beforeUpload" multiple>
