        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if (this.$refs.upload.uploadFiles.length === 0) {
              ...
              this.formData.append('num', this.ruleForm.num);
              this.formData.append('validity', this.ruleForm.validity);
              this.formData.append('filesNum', this.formData.length)

              uploadQrcode(this.formData).then(res => {
                if (res.code === 200) {
                  this.$message({
                    type: 'success',
                    message: '新建活码成功~'
