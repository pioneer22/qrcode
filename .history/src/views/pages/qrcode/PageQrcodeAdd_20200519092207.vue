          ...
          <el-card shadow="hover" style="width: 100%;">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
              ...
              <div class="upload-content">
                <el-upload class="upload-demo" ref="upload" :auto-upload="false" drag action=process.env.VUE-APP-URL
                  + "/qrcode/index/create_qrcode" list-type="picture" :on-success="handleSuccess" :file-list="fileList"
