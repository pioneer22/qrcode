          ...
          if (valid) {
            ...
            if (this.childTitle == '编辑子码') {
              ...
              if (this.$refs.upload.uploadFiles.length === 0) {
                ...
                this.formData.append('subcode_title', this.params.subcode_title)
                this.formData.append('subcode_sort', this.params.subcode_sort)
                this.formData.append('toplimit', this.params.toplimit)
                this.formData.append('validity', this.params.validity)
