            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
              ...
              <div class="upload-content">
                <el-upload class="upload-demo" ref="upload" :auto-upload="false" drag :action="url" list-type="picture"
                  :before-upload="beforeUpload" multiple :http-request="uploadFile" name="file[]">
  ...
  export default {
    ...
    methods: {
      ...
      uploadFile(file) {
        ...
        this.formDate.push(file.file)
        let images = [...this.formDate]
        images.forEach((img,index)=>{
          this.params.append(`file${index}`,item)
        }) */
