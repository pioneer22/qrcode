      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane :label="$t('permissions.user')" name="first" :lazy="true">
            ...
            <el-form :inline="true" :model="users.query">
              ...
              <el-form-item label="角色">
                <el-select v-model="users.query.role" placeholder="角色" multiple filterable>
                  <el-option v-for="_role in selectOptions.roleOption" :key="_role" :label="_role" :value="_role">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item>
          ...
          <el-card shadow="hover">
            <div slot="header" style="text-align: center">
              <b>用户列表</b>
              <el-button style="float: right;" type="success" size="mini" circle icon="el-icon-plus"
                @click="userHandleAdd()"></el-button>
            </div>
            <el-card shadow="hover">
              <el-table :data="users.table.slice((users.currentPage-1)*users.pageSize,users.currentPage*users.pageSize)"
                style="width: 100%">
              ...
              <el-pagination @size-change="userHandleSizeChange" @current-change="userHandleCurrentChange" background
                :current-page="users.currentPage" :page-sizes="[10, 20, 30, 40]" :page-size="users.pageSize"
                layout="total, sizes, prev, pager, next, jumper" :total="users.pageTotal">
              </el-pagination>
            </el-card>
          </el-card>
          <!-- Users *** Dialog -->
        ...
        <el-tab-pane :label="$t('permissions.role')" name="second" :lazy="true">
            ...
            <el-form :inline="true" :model="roles.query">
              ...
              <el-form-item label="页面">
                <el-select v-model="roles.query.page" placeholder="页面" multiple filterable>
                  <el-option v-for="_page in selectOptions.pageOption" :key="_page" :label="_page" :value="_page">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="地址">
                <el-select v-model="roles.query.path" placeholder="地址" multiple filterable>
                  <el-option v-for="_path in selectOptions.pathOption" :key="_path" :label="_path" :value="_path">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="指令">
                <el-select v-model="roles.query.directive" placeholder="指令" multiple filterable>
                  <el-option v-for="_directive in selectOptions.dirOption" :key="_directive" :label="_directive"
                    :value="_directive"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item>
          ...
          <el-card shadow="hover">
            <div slot="header" style="text-align: center">
              <b>角色列表</b>
              <el-button style="float: right;" type="success" size="mini" circle @click="roleHandleAdd()"
                icon="el-icon-plus"></el-button>
            </div>
            <el-card shadow="hover">
              <el-table :data="roles.table.slice((roles.currentPage-1)*roles.pageSize,roles.currentPage*roles.pageSize)"
                style="width: 100%">
                <el-table-column label="ID">
                  <template slot-scope="scope">
                    <span>{{ scope.row.id }}</span>
                ...
                <el-table-column label="权限" width="500">
                  <template slot-scope="scope">
                    <el-tag class="my-role-permission" v-for="_permission in scope.row.permission"
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <el-button size="mini" @click="roleHandleEdit(scope.$index, scope.row)">编辑
                    </el-button>
                    <el-button size="mini" type="danger" @click="roleHandleDelete(scope.$index, scope.row)">删除
                    </el-button>
                  </template>
                </el-table-column>
              </el-table>
              <el-pagination @size-change="roleHandleSizeChange" @current-change="roleHandleCurrentChange" background
                :current-page="roles.currentPage" :page-sizes="[10, 20, 30, 40]" :page-size="roles.pageSize"
                layout="total, sizes, prev, pager, next, jumper" :total="roles.pageTotal">
              </el-pagination>
            </el-card>
          </el-card>
          <!-- Roles *** Dialog -->
