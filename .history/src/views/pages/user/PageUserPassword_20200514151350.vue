    ...
    <div class="login-box">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px"
        ...
        <el-form-item prop="newPass">
          <el-input v-model="ruleForm.newPass" auto-complete="off" :placeholder="$t('login.newPass')">
          </el-input>
        </el-form-item>
        <el-form-item prop="checkPass">
          <el-input v-model="ruleForm.checkPass" auto-complete="off" :placeholder="$t('login.checkPass')"></el-input>
        </el-form-item>
