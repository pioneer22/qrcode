    ...
    <div class="login-box">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px"
        ...
        <el-form-item prop="oldPass">
          <el-input v-model="ruleForm.oldPass" auto-complete="off" :placeholder="$t('login.oldPass')">
          </el-input>
        </el-form-item>
        <el-form-item prop="newPass">
          <el-input type="password" v-model="ruleForm.newPass" auto-complete="off" :placeholder="$t('login.newPass')">
          </el-input>
        </el-form-item>
      ...
      return {
        ...
        rules: {
          oldPass: [
            ...
            { min: 6, message: this.$t('login.inputPass'), trigger: 'blur' }
          ],
          newPass: [
        ...
        this.$refs.ruleForm.validate((valid) => {
          if (valid) {
            this.$confirm(this.$t('login.changePassMessage'), this.$t('login.tip'), {
              ...
              /*  changePassword(changePasswordParams).then(data => {
                 this.loading = false
                 this.$message({
