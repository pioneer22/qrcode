<template>
  <div>
    ...
    <el-dialog title="新增用户" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="insertUser">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogFormVisible('insertUser')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
      ...
      rules() {
        return {
          ...
          password: [
            ...
            { min: 6, max: 18, message: '请输入数字', trigger: 'blur' }
          ]
        }
      }
    },
