    ...
    <div class="login-box">
            ...
            <g class="arms" clip-path="url(#armMask)">
              <g class="armL" style="visibility: hidden;">
                <polygon fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                  stroke-linejoin="round" stroke-miterlimit="10" points="121.3,98.4 111,59.7 149.8,49.3 169.8,85.4" />
                <path fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px"
        ...
        <el-form-item prop="checkPass">
          ...
          <div @click="forgetPassword" style="float: right; color: #bbbbbb;cursor: pointer;">{{$t('login.forgetPass')}}
          </div>
        </el-form-item>
    ...
    methods: {
      ...
      handleSubmit(ev) {
        const loginParams = {
          ...
          user_name: this.ruleForm.account, pass_word: this.ruleForm.checkPass
        }

        axios.get("http://hm.prettyvalley.net/qrcode/index/login?user_name=admin&pass_word=123456aabb").then(res => {
          console.log("res:", res)
        })

        axios.post('http://hm.prettyvalley.net/qrcode/index/login', { user_name: this.ruleForm.account, pass_word: this.ruleForm.checkPass }).then(res => {
          console.log("res:", res)
        }).catch(err => {
          console.log("err:", err)
        })
