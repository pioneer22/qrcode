...
export const requestUserInfo = params => {
  return request('/api/user/info', params).then(res => {
    // 过滤菜单
    c/* onst filterUserMenu = function (menus, accessMenu) {
...
export const requestLogin = params => ajax("http://open.prettyvalley.net:2019/home/Propagate/activities", params, 'POST')
