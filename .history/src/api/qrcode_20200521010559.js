...
// 生成活码
export const uploadQrcode = params => axios.post(process.env.VUE_APP_URL + '/qrcode/index/create_qrcode', params, config)
...
// 新增子码
export const addChildQrcode = params => axios.post(process.env.VUE_APP_URL + '/qrcode/index/add_subcode', params, config)
